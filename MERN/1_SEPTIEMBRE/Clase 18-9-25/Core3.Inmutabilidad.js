...
const ejercicio2 = videojuegos.filter(videojuego => videojuego.genero.includes("acción-RPG"));
//console.log("Ejercicio 2:", ejercicio2);

//------------ Un conjunto de videojuegos que tienen más de un género.
const ejercicio3 = videojuegos.filter(videojuego => videojuego.genero.includes(" "));
//console.log("Ejercicio 3:", ejercicio3);

//----------- Una lista con los nombres de los videojuegos.
const ejercicio4 = videojuegos.map(videojuego => videojuego.nombre);
...
const ejercicio9 = videojuegos.filter(juego => juego.id % 5 !== 0);
